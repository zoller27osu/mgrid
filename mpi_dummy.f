...
c     write ( *, '(a)' ) ' '
c     write ( *, '(a)' ) 'MPI_BSEND - Error!'
c     write ( *, '(a)' )  '  Should not send message to self.'
...
c     write ( *, '(a)' ) ' '
c     write ( *, '(a)' ) 'MPI_GET_COUNT - Error!'
c     write ( *, '(a)' ) '  Should not query message from self.'
...
c     write ( *, '(a)' ) ' '
c     write ( *, '(a)' ) 'MPI_IRECV - Error!'
c     write ( *, '(a)' ) '  Should not recv message from self.'
...
c     write ( *, '(a)' ) ' '
c     write ( *, '(a)' ) 'MPI_WAIT - Error!'
c     write ( *, '(a)' ) '  Should not wait on message from self.'
